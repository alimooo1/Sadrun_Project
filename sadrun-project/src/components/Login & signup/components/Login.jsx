            ...
            <div className='max-sm:flex max-sm:justify-center w-[620px] h-[650px]  bg-white'>
                    ...
                    max-sm:relative max-sm:top-[60px] max-sm:right-0 max-sm:border' data-aos='flip-left' data-aos-offset='100' data-aos-delay='300'>
                        ...
                        <div className='flex justify-center flex-col items-center'>
                            ...
                            <sapn className='font-vazirmatnSemiB' > ورود</sapn>
                        </div>
                        ...
                        <div className='flex flex-col px-8'>
                            ...
                            <div className='flex items-center justify-start'>
                                ...
                                <label className='font-vazirmatnLight text-[#C200BC]'>مرا به خاطر بسپار</label>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col justify-center items-center'>
                            ...
                            <Link className='font-vazirmatn text-[#C200BC] my-2' to='/Forgetfulnes'>فراموشی رمز عبور</Link>
