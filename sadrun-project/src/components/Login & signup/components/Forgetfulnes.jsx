        ...
        <div className={styles.container}>
            ...
            <div className={styles.box_lock}>
                    ...
                    <div className={styles.input_botton}>
                        ...
                        <Button className={styles.btn} buttonType={"form-sign-up-button"}> ادامه</Button>
                    </div>


                    <div className={styles.footer}>

                        <Link className={styles.link} to='/login'> ورود</Link>
                        <p className={styles.p}>|</p>
                        <Link className={styles.link} to='/signup'> ثبت نام</Link>
                    </div>
