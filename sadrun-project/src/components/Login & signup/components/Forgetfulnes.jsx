            ...
            <div className='max-sm:flex max-sm:justify-center w-[620px] h-[650px] bg-white'>
                ...
                data-aos='flip-left' data-aos-offset='100' data-aos-delay='300'>
                    ...
                    <div className='flex justify-center flex-col items-center'>
                        ...
                        <sapn className='font-vazirmatn text-lg mt-4' > فراموشی رمز عبور</sapn>
                    </div>
                    ...
                    <div className='flex flex-row justify-center items-center'>
                        ...
                        <Link className='font-vazirmatn text-[#C200BC] border-l-2 border-[#C200BC] ml-4 pl-4' to='/login'> ورود</Link>
                        <Link className='text-[#C200BC] font-vazirmatn' to='/signup'> ثبت نام</Link>
                    </div>
                </div>
